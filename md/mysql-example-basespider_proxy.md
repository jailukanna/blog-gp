---
title: mysql example basespider proxy (snippet)
date: 2020-03-03
tags: ["python"]
---
Python mysql example 'basespider proxy'
...
if __name__ == '__main__':
    ...
    with open('/home/spider/proxies/proxy.txt','wb')as w:
		w.truncate()
    for p in proxyes:
	print(p)
	with open('/home/spider/proxies/proxy.txt','a+')as w:
	    w.write('%s\n'%p)
