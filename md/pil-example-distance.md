---
title: pil example distance (snippet)
date: 2020-03-02
tags: ["python"]
---
Python pil example 'distance'
...
class Watch(object):
    """"Does image processing to determine the distance and direction to a
    target.
    """
    ...
    def _get_distance_m_direction_d(self, image):
        """Returns the distance in meters and the direction in degrees to the
