---
title: PIL example siamese dataset example (snippet)
date: 2020-03-02
tags: ["python"]
---
Python PIL example 'siamese dataset example'
...
## python siamese dataset example
...
root='/data/att_faces'
sd = SiameseDataset(root, ext="pgm")
sd.__getitem__(3)[0]
