---
title: tkinter example texteditor (snippet)
date: 2020-02-09
tags: ["python"]
---
Python tkinter example 'texteditor'
...
```python
#Basic Text Editor built with some features such as: save, open, clear, copy, paste, word count
