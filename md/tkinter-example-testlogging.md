---
title: tkinter example testlogging (snippet)
date: 2020-02-09
tags: ["python"]
---
Python tkinter example 'testlogging'
...
class myGUI(tk.Frame):
    ...
    def build_gui(self):                    
        ...
        # Old code - results in UnicodeEncodeError:
...
def worker():
    ...
    PPNs=["37750159X","344588807", "334634555"]
    ...
    for PPN in PPNs:
        ...
        if noGGCRecords == 0:
            ...
            msg = ("Search for PPN=" + PPN + " returned " + \
